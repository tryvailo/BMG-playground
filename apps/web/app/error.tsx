...
// Load default locale messages for error pages
const messagesPromise = import(`../messages/${routing.defaultLocale}.json`).then(m => m.default);
...
const ErrorPage = ({
  ...
  // Use React.use() to load messages
